							...
							case "2":
								...
								case "One":
									...
									do{
										...
										while(c1!=0){
											c1--;
											System.out.format("%32s",rsmd1.getColumnName(i1-c1));  
										}
										System.out.println();
										while(rs1.next()){
											c1=i1;
											while(c1!=0){
												c1--;
												System.out.format("%32s",rs1.getString(i1-c1));
											}
											System.out.println();
										}
								...
								case "Misc":
									...
									while(c2!=0){
										c2--;
										System.out.format("%32s",rsmd2.getColumnName(i2-c2));  
									}
									System.out.println();
									while(rs2.next()){
										c2=i2;
										while(c2!=0){
											c2--;
											System.out.format("%32s",rs2.getString(i2-c2));
										}
										System.out.println();
									}
									break;
			...
			case "2": //visitor
				...
				case "D":
					...
					if(a1.equals("Yes") && a2.equals("N") && a3.equals("Yes")){
						...
						temp1=input.nextInt();
						st4.setInt(5, temp1);
						System.out.println("Enter units donated");
						temp1=input.nextInt();
						st5.setInt(2, temp1);
						System.out.println("Enter DOB(YYYY-MM-DD)");
						temp2=input.next();
						st5.setString(3, temp2);
						System.out.println("Enter blood type");
						temp2=input.next();
						st5.setString(4, temp2);
						st5.setString(6, "2017-11-03");
						int count2 = st4.executeUpdate();
						int count3 = st5.executeUpdate();
						///////////TRIGGGERRRRRRR
				...
				case "R":
					String query1="insert into Visitor values(?,?,?,?,?)";
					String query2="ïnsert into Recipient values(?,?,?,?,?,?)";
					PreparedStatement st4 = con.prepareStatement(query1);
					PreparedStatement st5 = con.prepareStatement(query2);
					st5.setInt(1,r);
					r++;
					...
					temp1=input.nextInt();
					st4.setInt(5, temp1);
					System.out.println("Enter units reqd");
					temp1=input.nextInt();
					st5.setInt(2, temp1);
					...
					temp2=input.next();
					st5.setString(6, temp2);
					int count3 = st4.executeUpdate();
					int count4 = st5.executeUpdate();
